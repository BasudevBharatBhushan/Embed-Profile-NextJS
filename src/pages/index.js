  ...
  return (
    <>
      ...
      <main
        ...
        className="bg-custom-image min-h-screen p-4 bg-"
      >
        <div className="flex flex-col gap-2">
          ...
          <div className=" flex flex-col justify-around items-center">
            <p className=" text-4xl font-bold text-[#A6A6A6] my-4">
              Project Challenge
            </p>

            <p className=" text-center text-[#EBCF5F] text-4xl font-bold">
              Analyze Growth and Present Insight to the <br /> Telengana
              Government
            </p>
          </div>
        </div>
